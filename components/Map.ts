  ...
  return {
    ...
    model: {
      ...
      effects: {
        ...
        createMapInstance (state, payload, send, done) {
...
const mapComponent = chooComponent(map())
export const component = mapComponent.component
export const model = mapComponent.model
